import "./AboutUs.css";
import "animate.css";
import doctor1 from "../images/AboutUs 1.jpg";
import doctor2 from "../images/AboutUs 2.jpg";
import doctor3 from "../images/AboutUs 3.jpg";
import shape1 from "../images/shape 7.png";
import shape2 from "../images/shape 5.png";
import shape3 from "../images/shape 8.png";
import shape4 from "../images/shape 9.png";
const AboutUs = () => {
	return (
				...
				<div className="row h-100 align-items-center position-relative">
					...
					<div className="col-12 col-md-6 col-lg-6">
						...
						<div className="cards row">
							<div className="col-md-6 col-lg-6 col-12 mb-sm-20 mb-30">
								<h3>
									<span>
										<svg
